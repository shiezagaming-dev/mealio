export const fr = {
  ...
  scanner: {
    ...
    analyzing: "L'analyse de l'image...",
  ...
  auth: {
    ...
    forgotSubtitle: 'Entrez votre e-mail pour recevoir les instructions',
    forgotSubmit: 'Envoyer le lien',
    forgotSuccess: "Si un compte existe pour cet e-mail, nous avons envoyé les instructions de réinitialisation.",
